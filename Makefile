...
build:
	...
	go build -o polygon-edge -ldflags="\
    	-X 'github.com/mauricio-b-r/polygon-edge/versioning.Version=$(LATEST_VERSION)' \
		-X 'github.com/mauricio-b-r/polygon-edge/versioning.Commit=$(COMMIT_HASH)'\
		-X 'github.com/mauricio-b-r/polygon-edge/versioning.Branch=$(BRANCH)'\
		-X 'github.com/mauricio-b-r/polygon-edge/versioning.BuildTime=$(TIME)'" \
	main.go
